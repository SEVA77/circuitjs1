...
AppId={{B19E9EC9-ACB4-4842-B287-20441E2F5342}
AppName={#MyAppName}
...
OutputBaseFilename=CircuitJS1_Desktop_Mod_{#MyAppVersion}_x64_setup
...
[Files]
Source: "..\out\win-x64\CircuitJS1 Desktop Mod\CircuitSimulator.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\out\win-x64\CircuitJS1 Desktop Mod\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
