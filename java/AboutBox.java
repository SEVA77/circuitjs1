...
public class AboutBox extends PopupPanel {
	...
	AboutBox(String version) {
		...
		"<p>JavaScript conversion by Iain Sharp.(http://lushprojects.com/)</p>"+
		...
		"<p style=\"font-size:9px\">For details of licensing see http://www.gnu.org/licenses/.</p>"+
		"<p style=\"font-size:9px\">Source code (Paul): https://github.com/pfalstad/circuitjs1</p>"+
		"<p style=\"font-size:9px\">Source code (Usevalad): https://github.com/pfalstad/circuitjs1</p>"+
	    "<p style=\"font-size:9px\">Source code (Iain): https://github.com/sharpie7/circuitjs1</p>"));
