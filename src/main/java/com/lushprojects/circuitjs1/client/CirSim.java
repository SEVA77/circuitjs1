...
//    String baseURL = "http://www.falstad.com/circuit/";
	...
	*/
    ...
    public void composeMainMenu(MenuBar mainMenuBar, int num) {
    	...
    	passMenuBar.addItem(getClassCheckItem(Locale.LS("Add Double Coil Relay"), "Relay2Elm"));
...
//    			scopes[menuScope].adjustScale(.5);
		...
		try {
			requestBuilder.sendRequest(null, new RequestCallback() {
				...
				public void onResponseReceived(Request request, Response response) {
					...
					processSetupList(text, openDefault);
					// end or processing
					}
					else {
						Window.alert(Locale.LS("Can't load circuit list!"));
	...
	void processSetupList(String text, final boolean openDefault) {
...
//    public void keyReleased(KeyEvent e) {}
	...
	case 416: return new MBBSwitchElm(x1, y1, x2, y2, f, st);
		...
		case 425: return new Relay2Elm(x1, y1, x2, y2, f, st);
        }
    	return null;
    }
    ...
    public static CircuitElm constructElement(String n, int x1, int y1){
		...
		if (n=="Relay2Elm")
			return (CircuitElm) new Relay2Elm(x1, y1);
    	if (n=="MemristorElm")
